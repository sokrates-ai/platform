'use client'
import { Backpack, BookCopy, Home, School, Settings, Shield, Users } from 'lucide-react'
    ...
    <div className="fixed bottom-0 left-0 right-0 bg-black/90 backdrop-blur-lg text-white shadow-xl pb-[env(safe-area-inset-bottom)]">
      <div className="flex justify-around items-center h-16 px-2">
        <AdminAuthorization authorizationMode="component">
          {isAdminRegion ? (
            <ToolTip content={'Admin'} slateBlack sideOffset={8} side="top">
              <Link href={`/dash/admin`} className="flex flex-col items-center p-2">
                <Shield size={20} />
