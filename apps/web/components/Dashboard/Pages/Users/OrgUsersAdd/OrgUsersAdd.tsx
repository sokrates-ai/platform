...
function OrgUsersAdd() {
    const t = useTranslations('OrgUsersAdd')
                ...
                <>
                    ...
                    <div className="ml-10 mr-10 mx-auto bg-white rounded-xl shadow-sm px-4 py-4 anit ">
                        <div className="flex flex-col bg-gray-50 -space-y-1 px-5 py-3 rounded-md mb-3 ">
                            <h1 className="font-bold text-xl text-gray-800">{t('headings.inviteUsersTitle')}</h1>
                            <h2 className="text-gray-500 text-md">
                                {t('headings.inviteUsersSubtitle')}
                            </h2>
                        </div>
                        <div className="flex space-x-2 mx-auto">
                            <textarea
                                ...
                                placeholder={t('placeholders.emailsExample')}
                                name=""
                                id=""
                                aria-label={t('headings.inviteUsersSubtitle')}
                            ></textarea>
                        </div>
                        <div className="flex space-x-2 mx-auto my-5 ml-2 items-center justify-between">
                            <div className='flex space-x-2 items-center'>
                                <p className='flex items-center'>{t('labels.inviteCode')}</p>
                                <select
                            ...
                            <div className='flex flex-row-reverse '>
                                <button
                                    ...
                                    aria-label={t('buttons.sendInvites')}
                                >
                                    <UserPlus className="w-4 h-4" />
                                    <span>{t('buttons.sendInvites')}</span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col bg-gray-50 -space-y-1 px-5 py-3 rounded-md mt-3 mb-3 ">
                            <h1 className="font-bold text-xl text-gray-800">
                                {t('headings.invitedUsersTitle')}
                            </h1>
                            <h2 className="text-gray-500 text-md">
                                {t('headings.invitedUsersSubtitle')}
                            </h2>
                        </div>
                            ...
                            <table className="table-auto w-full text-left whitespace-nowrap rounded-md overflow-hidden">
                                <thead className="bg-gray-100 text-gray-500 rounded-xl uppercase">
                                    <tr className="font-bolder text-sm">
                                        ...
                                        <th className="py-3 px-4">{t('table.signupStatus')}</th>
                                        <th className="py-3 px-4">{t('table.emailSent')}</th>
                                    </tr>
                                </thead>
                                <>
