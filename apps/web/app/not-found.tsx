...
export default function NotFound() {
  return (
    <>
      <div className="relative w-full min-h-screen bg-SokratesWhite overflow-hidden bg-[url('/background-1.svg')] bg-repeat bg-auto">
        <div className="absolute inset-0 pointer-events-none bg-SokratesWhite/80" />
        ...
        <div className="flex flex-col items-center justify-center min-h-screen px-4 pt-32 pb-16 text-center relative z-10">
          <h1
            className="font-black leading-tight m-0 p-0 text-SokratesLightGray"
            style={{
              textShadow: '0px clamp(6px, 0.5vw, 8px) 0px var(--color-SokratesBlackBoxShadow)',
              WebkitTextStrokeWidth: 'clamp(2px, 0.5vw, 4px)',
              WebkitTextStrokeColor: 'var(--color-SokratesGrayBorder)',
          ...
          <p className="-mt-6 max-w-[95%] sm:max-w-[80%] md:max-w-[600px] text-SokratesGrayBorder2 font-medium leading-tight tracking-wider p-0 text-2xl sm:text-2xl md:text-2xl font-['DM_Sans']">
