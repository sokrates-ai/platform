...
function ExerciseCourseHome(params: ExerciseProps) {
    ...
    const COURSES_URL = `${getAPIUrl()}courses/org_slug/${(params as any).params.orgslug}/page/${course_page}/limit/${course_limit}`
        ...
        <div className="h-full w-full pl-10 pr-10">
            <div className="mb-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-4">
                    <h1 className="text-3xl font-bold mb-4 sm:mb-0">Course Exercises: <q>{course.name}</q></h1>
